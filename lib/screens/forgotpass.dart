        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.fromLTRB(
                    0, MediaQuery.of(context).size.width * 0.2, MediaQuery.of(context).size.width * 0.2, 0),
                child: Text(
                  "Forgot Password ?  ",
                  style: TextStyle(
                      fontSize: 36,
            ...
            Padding(
              ...
              child: Text("Don’t worry! It happens. Please enter the Phone Number associated with your account.",style: TextStyle(color: Colors.black.withOpacity(0.3),fontSize: 18),),
            ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("Remember Passsword?", style: TextStyle(color: Colors.black.withOpacity(0.4)),),
