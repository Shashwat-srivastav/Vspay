...
class VerifywithOTP extends StatelessWidget {
  const VerifywithOTP({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "We’ve sent an SMS with an activation code to your phone +33 294278411",
                  style: TextStyle(
              ...
              Padding(
                padding: EdgeInsets.fromLTRB(
                    8, MediaQuery.of(context).size.width * 0.06, 8, 8),
                child: Text(
                  "We’ve sent an SMS with an activation code to your Mail demo@icloud.com",
                  style: TextStyle(
                      color: Colors.black.withOpacity(0.3), fontSize: 18),
                ),
              ),
