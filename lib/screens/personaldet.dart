...
class PersonalDet extends StatefulWidget {
  const PersonalDet({super.key});

  @override
  State<PersonalDet> createState() => _PersonalDetState();
}

class _PersonalDetState extends State<PersonalDet> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text("Personal Details",style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),),
              ),
              //------------------
            ...
            children: [
              Padding(
                  padding: EdgeInsets.fromLTRB(
                      0, 0, MediaQuery.of(context).size.width * 0.58, 0),
                  child: Text(
                    "Name & surname",
                ...
                //----------------------
                        ...
                        children: [
                          Padding(
                            padding: EdgeInsets.fromLTRB(0, 0,
                                MediaQuery.of(context).size.width * 0.78, 0),
                            child: Text(
                              "Email",
                              style: TextStyle(fontSize: 16,color: Colors.black38),
                            ),
                      ...
                      child: Column(
                        children: [
                          Padding(
                            padding: EdgeInsets.fromLTRB(0, 0,
                                MediaQuery.of(context).size.width * 0.6, 0),
                            child: Text(
                              "Phone Number",
                              style: TextStyle(fontSize: 16,color: Colors.black38),
                            ),
